...
const styles = {
  container: `fixed md:block hidden w-[7%] border-[1px] border-[#EBECF2] h-screen pl-3 dark:border-white/10 dark:bg-outer_dark bg-home`,
  mobile_container: "block w-[15%] fixed h-screen pl-3 dark:border-white/10 dark:bg-outer_dark bg-home",
  ...
  bodyContainer: 'mb-10 md:mt-[7%] mt-[20%] md:mx-4 mx-2 pr-4 pl-0  flex md:flex-row flex-col gap-[1rem] w-full',

  // Navbar Styles -------------
  navCont: 'flex fixed justify-between p-2 dark:bg-outer_dark bg-[#FAFAFA] md:w-[93%] w-full md:pr-6 md:pl-4 pl-0 pr-2 border-[1px] border-[#E5EAEF] dark:border-white/10 z-30',
